import { findRecentAudit, type AuditEntry } from "@/lib/audit";
...
export default async function ActivityPage() {
  const entries = await findRecentAudit(100);

  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-bold text-slate-800">活動ログ</h2>
        <p className="text-sm text-slate-500 mt-1">
          誰がいつ何を更新したかの履歴。直近 100 件を表示。
        </p>
      </div>
